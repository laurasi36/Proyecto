...
<br><br><br><br><br><br><br>
    <main>
        <section class="container " id="infojunior">
            <?php
                ...
                while(($row = $result->fetch(PDO::FETCH_ASSOC)) && ($row2 = $result2->fetch(PDO::FETCH_ASSOC))){
                    echo "<td class='item'>";
                    echo "<a href='informacionJunior.php?id={$row["id"]}'><img id='imgPlayeroBD' src='data:image/png; base64, ".base64_encode($row["image"])."'></a><br>";
